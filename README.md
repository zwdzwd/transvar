...
current stable version: [2.0.2.20150407](https://bitbucket.org/wanding/transvar/get/v2.0.2.20150407.zip)
...
```
#!text
Q5VUM1:47	CCDS4972.1 (protein_coding)	C6ORF57	+	chr6:g.71289191_71289193/c.139_141/p.47S	cds_in_exon_2	protein_sequence=S;cDNA_sequence=TCC;gDNA_sequence=TCC
```
