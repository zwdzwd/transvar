...
class AnnoDB():
    ...
    def query_dbsnp_codon(self, r, codon, taa_alt):
        ...
        dbsnps = []
        for tnuc_altseq in trs.reverse_codon_table[taa_alt]:
            subs = []
            ...
            if len(subs) == 1:
                ...
                gnuc_alt = tnuc_altbase if codon.strand == '+' else trs.complement(tnuc_altbase)
            ...
            if len(subs) == 2:
                ...
                if i1+1 == i2 and abs(codon.tloc(i1)-codon.tloc(i2)) == 1:
                    ...
                    gnuc_alt = tnuc_alt if codon.strand == '+' else trs.reverse_complement(tnuc_alt)
            ...
            if len(subs) == 3:
                ...
                if i1+2 == i2 and abs(codon.tloc(i1)-codon.tloc(i2)) == 2:
                    ...
                    gnuc_end = max(codon.tloc(i1), codon.tloc(i2))
                    tnuc_alt = codon.seq
                    gnuc_alt = codon.seq if codon.strand == '+' else trs.reverse_complement(codon.seq)
                    dbsnps.extend(self._query_dbsnp_(r.chrm, gnuc_beg, gnuc_end, gnuc_alt))
